...
public class MainpageAdmin_Controller {
    ...
    @FXML
        private void handleProfileButton(ActionEvent event) {
            ...
            loadContent("/com/example/View/login.fxml");
    ...
    private void handleUserButton(ActionEvent event) {
        ...
        Button clickedButton = (Button) event.getSource();
        updateButtonStyles(clickedButton);
        loadContent("/com/example/View/Users.fxml");
    ...
    private void handleLogoutButton(ActionEvent event) throws IOException{
        ...
        // Create a new stage for the adminPage window
        Stage LogInStage = new Stage();
        LogInStage.setScene(scene);
        LogInStage.show();

        // Close the current stage (adminPage window)
        Stage adminMainPageStage = (Stage)((Node) event.getSource()).getScene().getWindow();
        adminMainPageStage.close();
    }
}
